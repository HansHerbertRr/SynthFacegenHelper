...
namespace SynthNPCsWithFaces
{
    class Program
    {
        ...
        public static void RunPatch(IPatcherState<ISkyrimMod, ISkyrimModGetter> state)
        {
            ...
            var burnedAstrid = FormKey.Factory("0004D6D0:Skyrim.esm");
            ...
            var npcs = state.LoadOrder.PriorityOrder.Npc()
                ...
                .Where(npc => !npc.Configuration.TemplateFlags.HasFlag(NpcConfiguration.TemplateFlag.IsChargenFacePreset))
